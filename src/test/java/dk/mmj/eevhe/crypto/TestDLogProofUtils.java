...
import dk.mmj.eevhe.crypto.zeroknowledge.DLogProofTestUtils;
...
import static dk.mmj.eevhe.crypto.TestUtils.getKeyGenParamsFromP2048bitsG2;
import static dk.mmj.eevhe.crypto.TestUtils.getKeyGenParamsFromP227G172;
import static dk.mmj.eevhe.crypto.zeroknowledge.DLogProofUtils.generateProof;
...
public class TestDLogProofUtils {
    ...
    public void setupProofsForPartialDecryptions() {
        ...
        BigInteger h = SecurityUtils.lagrangeInterpolate(publicValues, distKeyGenResult.getP());
    ...
    public void shouldVerifyFakeProof() {
        ...
        BigInteger h = SecurityUtils.lagrangeInterpolate(publicValues, p);
        PublicKey publicKey = new PublicKey(h, g, q);
